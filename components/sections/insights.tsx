  ...
  return (
    <section className="border-b border-rule">
      <div className="mx-auto max-w-295 px-5 py-16 md:px-7 md:py-20">
        <Reveal>
          <SectionHeading eyebrow="Insights" title="Writing on Nigerian compliance and risk" />
        </Reveal>
        {INSIGHTS_CONFIRMED && ARTICLES.length > 0 ? (
          ...
          <Reveal delay={100} className="mt-10">
            <PendingNote>
              The first articles are in progress — covering NDPA obligations, the CBN
              risk-based cybersecurity framework, and what enforcement activity means for
              Nigerian organisations. Check back shortly.
            </PendingNote>
          </Reveal>
        )}
